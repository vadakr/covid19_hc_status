...
--SIGNUP
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[COV19HCSTAT].[SIGNUP]') AND OBJECTPROPERTY(id, N'ISUSERTABLE') = 1)
    DROP TABLE [COV19HCSTAT].[SIGNUP]
GO
...
--SIGNUP
create table COV19HCSTAT.SIGNUP
(
    PK          BIGINT IDENTITY
                CONSTRAINT SIGNUP_PK PRIMARY KEY,
    -- user
    LAST        NVARCHAR(250)  NOT NULL,
    FIRST       NVARCHAR(250)  NOT NULL,
    EMAIL       NVARCHAR(500)  NOT NULL,
    ...
    FADDR1      NVARCHAR(500)  NOT NULL,
    FADDR2      NVARCHAR(500)  NULL,
    FZIP        INT NOT NULL,
    FCOUNTY     NVARCHAR(500)  NULL,
    FSTATE      NVARCHAR(2) NOT NULL,
    -- for triage
...
go
CREATE INDEX SIGNUP_IDX1 ON COV19HCSTAT.SIGNUP (PROCESSED)
CREATE INDEX SIGNUP_IDX2 ON COV19HCSTAT.SIGNUP (CREATED)
CREATE INDEX SIGNUP_IDX3 ON COV19HCSTAT.SIGNUP (FNAME)
CREATE INDEX SIGNUP_IDX4 ON COV19HCSTAT.SIGNUP (FZIP)
CREATE INDEX SIGNUP_IDX5 ON COV19HCSTAT.SIGNUP (FSTATE)
go
